...
#============================================================
f=3 # f index := file this is  a trial for bigger funtion 
#============================================================
...
list.save(main.list,'ds.reg4mpiesm.rdata')

load('ds.reg4mpiesm.rdata')
# #-- Anaylsis
# load('ds.reg4mpiesm.rdata')
# ds.list<-x
# !=================!
...
list.save(daysc.bc.list,'day_sc_bc_reg4mpiesm.rdata')
...
list.save(sc.bc.list,'ext_sc_bc_reg4mpiesm.rdata')