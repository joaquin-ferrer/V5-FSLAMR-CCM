...
load('wan-rcm-expanded-ts.rdata')
obs.ts <-x
...
list.save(main.list,'ds.remohadgem.rdata')
# 
# #-- Anaylsis
# load('ds.remohadgem.rdata')
# ds.list<-x
# !=================!
# PERFORM SWEEP TEST!
# !=================!
...
list.save(daysc.bc.list,'day_sc_bc_remohadgem.rdata')
...
list.save(sc.bc.list,'ext_sc_bc_remohadgem.rdata')
