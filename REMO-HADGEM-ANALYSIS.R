...
load('day_sc_bc_hadgem.rdata')
day.sc<-x
load('day_val_bc_hadgem.rdata')
day.ref<-x
...
ggplot()+
  ...
  labs(title=paste("Return Period Curves\nGCM-RCM: HadGEM-REMO"),x="Return Period [years]",y="Precipitation [mm/day]",color="Scenario")+
  theme_pubr()
